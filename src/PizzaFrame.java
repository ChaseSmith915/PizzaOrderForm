...
public class PizzaFrame extends JFrame{
    ...
    JCheckBox cheeseBox;
    JCheckBox gatoradeBox;
    JCheckBox feetBox;
    JCheckBox jawbreakerBox;
    ...
    private void createMiddlePanel()
    {
        ...
        gatoradeBox= new JCheckBox("Gatorade");
        feetBox= new JCheckBox("Frog Feet");
        jawbreakerBox= new JCheckBox("Jawbreakers");
        ...
        toppingsPnl.add(gatoradeBox);
        toppingsPnl.add(feetBox);
        toppingsPnl.add(jawbreakerBox);
    ...
    private void createBottomPanel()
    {
        ...
        orderButton.addActionListener(
                (ActionEvent ae) -> {
                    ...
                    if(gatoradeBox.isSelected())
                    {
                        receiptText.append("\n" +"Gatorade         $1.00");
                        total += 1;
                    }
                    if(feetBox.isSelected())
                    {
                        receiptText.append("\n" +"Frog feet         $1.00");
                        total += 1;
                    }
                    if(jawbreakerBox.isSelected())
                    {
                        receiptText.append("\n" +"Jawbreakers         $1.00");
                        total += 1;
                    }
        ...
        clearButton.addActionListener(
                (ActionEvent ae) -> {
                    ...
                    feetBox.setSelected(false);
                    gatoradeBox.setSelected(false);
                    miniPizzaBox.setSelected(false);
                    jawbreakerBox.setSelected(false);
                }
